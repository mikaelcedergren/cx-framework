...
import { CxTableCellDirective, type CxTableColumn, type CxTableDensity, type CxTableRowActivation, type CxTableSelectionMode, type CxTableColumnPinChangeEvent, type CxTableColumnVisibilityChangeEvent, type CxTableRowActivateEvent, type CxTableRow, type CxTableRowMenuSelectEvent, type CxTableSort, type CxTableSortDirection, type CxTableStateMessage, type CxTableEmptyStateAction } from '../../primitives/data/cx-table';
...
export declare class CxTableViewComponent {
    protected readonly customCells: import("@angular/core").Signal<readonly CxTableCellDirective[]>;
