...
import { ChangeDetectionStrategy, Component, EventEmitter, Input, Output, ViewChild, computed, contentChildren, signal, } from '@angular/core';
import { CxFilterBarComponent, } from '../cx-filter-bar/index.js';
import { CxTableComponent, CxTableCellDirective, } from '../../primitives/data/cx-table/index.js';
...
export class CxTableViewComponent {
    customCells = contentChildren(CxTableCellDirective, { ...(ngDevMode ? { debugName: "customCells" } : /* istanbul ignore next */ {}), descendants: true });
