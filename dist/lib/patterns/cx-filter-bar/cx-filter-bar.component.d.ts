...
export declare class CxFilterBarComponent implements AfterViewInit, OnDestroy {
    ...
    protected readonly tagFilterMetrics$: import("@angular/core").Signal<CxFilterBarTagSurfaceMetrics | undefined>;
    /**
