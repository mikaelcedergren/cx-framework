...
import { CxStateMessageComponent } from '../../primitives/feedback/cx-state-message/index.js';
...
export class CxWizardDialogComponent {
    ...
    processing$ = computed(() => this.wizard$().processing, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "processing$" }] : /* istanbul ignore next */ []));
    isLarge$ = computed(() => this.wizard$().size === 'large', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "isLarge$" }] : /* istanbul ignore next */ []));
    dismissible$ = computed(() => this.wizard$().dismissible === true, /* @ts-ignore */
    ...
    processingComplete = new EventEmitter();
    ...
    completeProcessing() {
        ...
        if (!run || !this.openState() || !run.elapsed || run.emitted ||
            this.processing$()?.id !== run.id || this.processing$()?.state !== 'success')
            return;
        run.emitted = true;
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.8", ngImport: i0, type: CxWizardDialogComponent, decorators: [{
        ...
        }], propDecorators: { stepTemplates: [{ type: i0.ContentChildren, args: [i0.forwardRef(() => CxWizardDialogStepDirective), { isSignal: true }] }], processingContent: [{
                type: ViewChild,
                args: ['processingContent', { read: ElementRef }]
            }], feedbackContent: [{
                type: ViewChild,
