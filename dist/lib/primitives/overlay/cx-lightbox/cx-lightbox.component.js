...
export class CxLightboxComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "22.0.8", type: CxLightboxComponent, isStandalone: true, selector: "cx-lightbox", inputs: { images: "images", index: "index", ariaLabel: "ariaLabel", previousAriaLabel: "previousAriaLabel", nextAriaLabel: "nextAriaLabel", open: "open" }, outputs: { indexChange: "indexChange", openChange: "openChange" }, host: { listeners: { "document:keydown": "onDialogKeydown($event)" } }, ngImport: i0, template: "@if (isOpen$()) {\n  @if (currentImage$(); as image) {\n    <div\n      class=\"cx-lightbox\"\n      [class.cx-lightbox--gallery]=\"hasNavigation$()\"\n      role=\"dialog\"\n      aria-modal=\"true\"\n      cdkTrapFocus\n      [cdkTrapFocusAutoCapture]=\"true\"\n      [attr.aria-label]=\"ariaLabel\"\n      [attr.aria-keyshortcuts]=\"hasNavigation$() ? 'Escape ArrowLeft ArrowRight' : 'Escape'\"\n      (click)=\"onBackdropClick($event)\"\n    >\n      @if (hasNavigation$()) {\n        <cx-icon-button\n          class=\"cx-lightbox__control cx-lightbox__navigation cx-lightbox__previous\"\n          icon=\"chevron-left\"\n          variant=\"emphasis\"\n          [rounded]=\"true\"\n          [ariaLabel]=\"previousAriaLabel\"\n          [disabled]=\"!canGoPrevious$()\"\n          (pressed)=\"showPreviousImage()\"\n        />\n      }\n\n      <figure class=\"cx-lightbox__surface\" tabindex=\"-1\" cdkFocusInitial>\n        <img class=\"cx-lightbox__image\" [src]=\"image.src\" [alt]=\"image.alt\" />\n        @if (image.caption || hasNavigation$()) {\n          <figcaption class=\"cx-lightbox__meta\">\n            @if (image.caption) {\n              <span class=\"cx-lightbox__caption\">{{ image.caption }}</span>\n            }\n            @if (hasNavigation$()) {\n              <span\n                class=\"cx-lightbox__position\"\n                role=\"status\"\n                aria-live=\"polite\"\n                aria-atomic=\"true\"\n                [attr.aria-label]=\"positionLabel$()\"\n              >\n                {{ positionText$() }}\n              </span>\n            }\n          </figcaption>\n        }\n      </figure>\n\n      @if (hasNavigation$()) {\n        <cx-icon-button\n          class=\"cx-lightbox__control cx-lightbox__navigation cx-lightbox__next\"\n          icon=\"chevron-right\"\n          variant=\"emphasis\"\n          [rounded]=\"true\"\n          [ariaLabel]=\"nextAriaLabel\"\n          [disabled]=\"!canGoNext$()\"\n          (pressed)=\"showNextImage()\"\n        />\n      }\n    </div>\n  }\n}\n", styles: [":host{display:contents}.cx-lightbox{position:fixed;inset:0;z-index:var(--z-index-dialog);display:grid;grid-template-columns:minmax(0, 1fr);grid-template-rows:minmax(0, 1fr);align-items:center;gap:var(--space-md);padding:clamp(var(--space-xl),5vmin,var(--space-2xl));overflow:auto;background:var(--overlay-backdrop);backdrop-filter:blur(var(--frost-softness));box-sizing:border-box}.cx-lightbox--gallery{grid-template-columns:var(--controller-size) minmax(0, 1fr) var(--controller-size)}.cx-lightbox__surface{grid-column:1;grid-row:1;display:grid;width:fit-content;min-width:0;max-width:100%;max-height:calc(100dvh - clamp(var(--space-xl),5vmin,var(--space-2xl))*2);gap:var(--space-sm);justify-items:center;justify-self:center;margin:0;outline:none;animation:cx-lightbox-image-enter calc(var(--motion-slow)*2) var(--ease-out-strong)}.cx-lightbox--gallery .cx-lightbox__surface{grid-column:2}.cx-lightbox__image{display:block;width:auto;min-width:0;max-width:100%;max-height:calc(100dvh - clamp(var(--space-xl),5vmin,var(--space-2xl))*2 - var(--controller-size) - var(--space-sm));object-fit:contain;border-radius:var(--radius-xl);box-shadow:var(--shadow-mid);background:var(--surface)}.cx-lightbox__meta{display:grid;max-width:min(100%,720px);gap:var(--space-xs);justify-items:center}.cx-lightbox__caption{color:var(--on-ink);font-size:var(--font-size-body-sm);line-height:var(--line-height-body-relaxed);text-align:center}.cx-lightbox__position{color:var(--on-ink);font-size:var(--font-size-body-xs);font-variant-numeric:tabular-nums;line-height:var(--line-height-small);opacity:.64}.cx-lightbox__control{border-radius:var(--radius-pill);corner-shape:round;box-shadow:var(--shadow-low)}.cx-lightbox__navigation{grid-row:1;align-self:center}.cx-lightbox__previous{grid-column:1;justify-self:start}.cx-lightbox__next{grid-column:3;justify-self:end}@keyframes cx-lightbox-image-enter{from{opacity:0;transform:translateY(var(--space-sm)) scale(0.985)}to{opacity:1;transform:translateY(0) scale(1)}}@media(prefers-reduced-motion: reduce){.cx-lightbox__surface{animation:none}}"], dependencies: [{ kind: "ngmodule", type: A11yModule }, { kind: "directive", type: i1.CdkTrapFocus, selector: "[cdkTrapFocus]", inputs: ["cdkTrapFocus", "cdkTrapFocusAutoCapture"], exportAs: ["cdkTrapFocus"] }, { kind: "component", type: CxIconButtonComponent, selector: "cx-icon-button", inputs: ["icon", "ariaLabel", "role", "ariaHasPopup", "ariaExpanded", "ariaControls", "mood", "variant", "size", "selected", "ariaPressed", "rounded", "disabled", "badgeValue", "block", "loading", "countdown"], outputs: ["pressed", "countdownChange"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
