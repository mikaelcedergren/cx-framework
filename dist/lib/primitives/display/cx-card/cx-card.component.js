...
export class CxCardComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "22.0.8", type: CxCardComponent, isStandalone: true, selector: "cx-card", inputs: { heading: "heading", icon: "icon", mood: "mood", variant: "variant", interactive: ["interactive", "interactive", booleanAttribute], href: "href", target: "target", rel: "rel", ariaLabel: "ariaLabel", menuItems: "menuItems", expandable: ["expandable", "expandable", booleanAttribute], previewHeight: "previewHeight", tabs: "tabs", selectedTabId: "selectedTabId", tabsAriaLabel: "tabsAriaLabel" }, outputs: { menuItemSelect: "menuItemSelect", pressed: "pressed", selectedTabIdChange: "selectedTabIdChange" }, host: { properties: { "class.cx-card-host--border": "variant === \"border\"", "class.cx-card-host--interactive": "activatable", "class.cx-card-host--mood-primary": "mood === \"primary\"", "class.cx-card-host--mood-accent": "mood === \"accent\"", "class.cx-card-host--mood-info": "mood === \"info\"", "class.cx-card-host--mood-success": "mood === \"success\"", "class.cx-card-host--mood-warning": "mood === \"warning\"", "class.cx-card-host--mood-danger": "mood === \"danger\"" } }, viewQueries: [{ propertyName: "cardViewportRef", first: true, predicate: ["cardViewport"], descendants: true, read: ElementRef }, { propertyName: "cardContentRef", first: true, predicate: ["cardContent"], descendants: true, read: ElementRef }, { propertyName: "cardMetaRef", first: true, predicate: ["cardMeta"], descendants: true, read: ElementRef }], usesOnChanges: true, ngImport: i0, template: "<div class=\"cx-card\">\n  @if (resolvedHref; as href) {\n    <a\n      class=\"cx-card__activation\"\n      [attr.href]=\"href\"\n      [attr.target]=\"target?.trim() || null\"\n      [attr.rel]=\"resolvedRel\"\n      [attr.aria-label]=\"activationLabel\"\n    ></a>\n  } @else if (interactive) {\n    <button\n      type=\"button\"\n      class=\"cx-card__activation\"\n      [attr.aria-label]=\"activationLabel\"\n      (click)=\"onActivate()\"\n    ></button>\n  }\n\n  <div class=\"cx-card__header\">\n    <div class=\"cx-card__identity\">\n      @if (icon; as iconName) {\n        <cx-icon class=\"cx-card__icon\" [icon]=\"iconName\" [size]=\"20\" />\n      }\n      @if (hasHeading()) {\n        <div class=\"cx-card__heading\">{{ heading!.trim() }}</div>\n      }\n    </div>\n\n    <div class=\"cx-card__header-actions\">\n      <div #cardMeta class=\"cx-card__meta\">\n        <ng-content select=\"[slot=meta], [cxCardMeta]\" />\n      </div>\n\n      @if (hasMenuItems()) {\n        <cx-menu\n          [presentation]=\"{ kind: 'trigger' }\"\n          class=\"cx-card__menu\"\n          [items]=\"menuItems ?? []\"\n          [ariaLabel]=\"resolvedMenuAriaLabel()\"\n          align=\"end\"\n          (itemSelect)=\"onMenuItemSelect($event)\"\n        >\n          <cx-icon-button\n            cxMenuTrigger\n            icon=\"menu-vertical\"\n            variant=\"transparent\"\n            [ariaLabel]=\"resolvedMenuAriaLabel()\"\n          />\n        </cx-menu>\n      }\n    </div>\n  </div>\n\n  @if (hasTabs) {\n    <cx-tabs\n      class=\"cx-card__tabs\"\n      [items]=\"tabs ?? []\"\n      [selectedId]=\"selectedTabId\"\n      [ariaLabel]=\"resolvedTabsAriaLabel\"\n      [controlsId]=\"contentId\"\n      [transparent]=\"true\"\n      [divided]=\"true\"\n      (selectedIdChange)=\"onTabSelect($event)\"\n    />\n  }\n\n  <div\n    #cardViewport\n    class=\"cx-card__viewport\"\n    [id]=\"contentId\"\n    [class.cx-card__viewport--expandable]=\"expansionEnabled\"\n    [class.cx-card__viewport--clamped]=\"clamped()\"\n    [style.maxHeight.px]=\"viewportMaxHeight()\"\n    [attr.role]=\"hasTabs ? 'tabpanel' : null\"\n    [attr.aria-labelledby]=\"hasTabs ? selectedTabButtonId : null\"\n    [attr.aria-label]=\"hasTabs && !selectedTabButtonId ? resolvedTabsAriaLabel : null\"\n    [attr.tabindex]=\"hasTabs ? '0' : null\"\n    (focusin)=\"onViewportFocusIn($event)\"\n  >\n    <div #cardContent class=\"cx-card__content\">\n      <ng-content />\n    </div>\n  </div>\n\n  @if (overflowing()) {\n    <button\n      type=\"button\"\n      class=\"cx-card__expand\"\n      [attr.aria-expanded]=\"expanded()\"\n      [attr.aria-controls]=\"contentId\"\n      [attr.aria-label]=\"expandAriaLabel()\"\n      (click)=\"toggleExpanded()\"\n    >\n      <cx-icon class=\"cx-card__expand-chevron\" icon=\"chevron-down\" [size]=\"16\" />\n    </button>\n  }\n\n  <div class=\"cx-card__footer\">\n    <ng-content select=\"[slot=footer], [cxCardFooter]\" />\n  </div>\n</div>\n", styles: [":host{display:block}.cx-card{position:relative;display:flex;width:100%;height:100%;min-width:0;min-height:0;flex-direction:column;gap:var(--surface-separation);overflow:hidden;border:0;border-radius:var(--radius-lg);background-color:var(--opacity-low);box-shadow:none;box-sizing:border-box;padding:var(--surface-separation);transition:background-color var(--motion-fast) var(--ease-out),border-color var(--motion-fast) var(--ease-out),box-shadow var(--motion-fast) var(--ease-out),transform var(--motion-fast) var(--ease-out)}:host(.cx-card-host--border) .cx-card{border:var(--line);background-color:rgba(0,0,0,0)}:host(.cx-card-host--interactive){position:relative}:host(.cx-card-host--interactive:has(.cx-card__activation:hover)){z-index:1}.cx-card__activation{position:absolute;z-index:1;border:0;border-radius:inherit;appearance:none;background:rgba(0,0,0,0);cursor:pointer;inset:0;outline:none}:host(.cx-card-host--interactive) :is(.cx-card__header,.cx-card__viewport,.cx-card__footer){pointer-events:none}:host(.cx-card-host--interactive) .cx-card__header-actions{position:relative;z-index:2;pointer-events:none}:host(.cx-card-host--interactive) .cx-card__menu{pointer-events:auto}:host(.cx-card-host--interactive) .cx-card:has(.cx-card__activation:hover){background-color:var(--opacity-low)}:host(.cx-card-host--interactive) .cx-card:has(.cx-card__activation:active){background-color:var(--opacity-darken)}:host(.cx-card-host--interactive.cx-card-host--border) .cx-card:has(.cx-card__activation:hover){border-color:var(--border-hover);background-color:rgba(0,0,0,0)}:host(.cx-card-host--interactive.cx-card-host--border) .cx-card:has(.cx-card__activation:active){border-color:var(--border-active);background-color:rgba(0,0,0,0)}@media(hover: hover){:host(.cx-card-host--interactive) .cx-card:has(.cx-card__activation:hover){transform:scale(1.01);box-shadow:var(--shadow-mid)}}:host(.cx-card-host--interactive) .cx-card:has(.cx-card__activation:active){transform:none;box-shadow:none}@media(prefers-reduced-motion: reduce){:host(.cx-card-host--interactive) .cx-card:has(.cx-card__activation:hover),:host(.cx-card-host--interactive) .cx-card:has(.cx-card__activation:active){transform:none}}:host(.cx-card-host--interactive) .cx-card:has(.cx-card__activation:focus-visible){outline:var(--outline-tab);outline-offset:var(--outline-tab-offset)}:host(.cx-card-host--mood-primary) .cx-card__icon{color:var(--primary)}:host(.cx-card-host--mood-accent) .cx-card__icon{color:var(--accent)}:host(.cx-card-host--mood-info) .cx-card__icon{color:var(--info)}:host(.cx-card-host--mood-success) .cx-card__icon{color:var(--success)}:host(.cx-card-host--mood-warning) .cx-card__icon{color:var(--warning)}:host(.cx-card-host--mood-danger) .cx-card__icon{color:var(--danger)}.cx-card__header{display:flex;min-width:0;min-height:var(--controller-size);align-items:center;gap:var(--space-md);padding:0 var(--space-sm);box-sizing:border-box}.cx-card__header:not(:has(.cx-card__heading,.cx-card__icon,.cx-card__meta>*,.cx-card__menu)){display:none}.cx-card__identity{display:flex;min-width:0;flex:1 1 auto;align-items:center;gap:var(--space-sm)}.cx-card__icon{flex:0 0 auto;color:var(--ink)}.cx-card__heading{min-width:0;overflow:hidden;color:var(--ink);font-size:var(--font-size-body);font-weight:var(--font-weight-bold);line-height:var(--line-height-body);text-overflow:ellipsis;white-space:nowrap}.cx-card__header-actions{display:inline-flex;min-width:0;flex:0 1 auto;align-items:center;justify-content:flex-end;gap:var(--space-sm);margin-inline-start:auto}.cx-card__meta{display:inline-flex;min-width:0;flex:0 1 auto;align-items:center;justify-content:flex-end;gap:var(--space-sm)}.cx-card__meta:empty{display:none}.cx-card__menu{display:inline-flex;flex:0 0 auto;opacity:.15;transition:opacity var(--motion-fast) ease}.cx-card:hover .cx-card__menu,.cx-card:focus-within .cx-card__menu{opacity:1}.cx-card__viewport:has(>.cx-card__content:empty){display:none}.cx-card:not(:has(.cx-card__heading,.cx-card__icon,.cx-card__meta>*)):has(.cx-card__content:empty):has(.cx-card__footer:empty){display:none}.cx-card__tabs{min-width:0;flex:0 0 auto;padding-inline:var(--space-sm)}.cx-card__viewport{position:relative;display:flex;min-width:0;min-height:0;flex:1 1 auto;flex-direction:column;overflow:hidden;border-radius:var(--radius-lg);transition:max-height var(--motion-base) var(--ease-out-in)}.cx-card__viewport:focus-visible{outline:var(--outline-tab);outline-offset:calc(-1*var(--outline-tab-offset))}.cx-card__content{display:flex;min-width:0;min-height:0;flex:1 1 auto;flex-direction:column;gap:var(--space-sm);overflow:hidden;border-radius:var(--radius-lg);background:rgba(0,0,0,0);padding:var(--space-sm);box-sizing:border-box}.cx-card__viewport--expandable .cx-card__content{flex-shrink:0}.cx-card__viewport--clamped{-webkit-mask-image:linear-gradient(to bottom, #000 calc(100% - 48px), transparent);mask-image:linear-gradient(to bottom, #000 calc(100% - 48px), transparent)}.cx-card__expand{display:flex;min-height:var(--controller-size);flex:0 0 auto;align-items:center;justify-content:center;padding:0 var(--space-sm);border:0;border-radius:var(--radius-lg);background:rgba(0,0,0,0);color:var(--opacity-high);cursor:pointer;transition:background-color var(--motion-fast) var(--ease-out),color var(--motion-fast) var(--ease-out)}.cx-card__expand:hover{background:var(--opacity-low);color:var(--ink)}:host(.cx-card-host--border) .cx-card__expand:hover{background:rgba(0,0,0,0)}.cx-card__expand:focus-visible{outline:var(--outline-tab);outline-offset:var(--outline-tab-offset)}.cx-card__expand-chevron{flex:0 0 auto;transition:transform var(--motion-fast) var(--ease-out)}.cx-card__expand[aria-expanded=true] .cx-card__expand-chevron{transform:rotate(180deg)}.cx-card__footer{display:flex;min-width:0;min-height:var(--controller-size);flex:0 0 auto;align-items:center;gap:var(--space-sm);padding:var(--space-sm);border-top:var(--line-discreet);box-sizing:border-box;color:var(--opacity-high);font-size:var(--font-size-body-sm);line-height:var(--line-height-small)}.cx-card__footer:empty{display:none}@media(prefers-reduced-motion: reduce){.cx-card__viewport,.cx-card__expand-chevron{transition:none}}"], dependencies: [{ kind: "component", type: CxIconButtonComponent, selector: "cx-icon-button", inputs: ["icon", "ariaLabel", "role", "ariaHasPopup", "ariaExpanded", "ariaControls", "mood", "variant", "size", "selected", "ariaPressed", "rounded", "disabled", "badgeValue", "block", "loading", "countdown"], outputs: ["pressed", "countdownChange"] }, { kind: "component", type: CxIconComponent, selector: "cx-icon", inputs: ["icon", "size", "mood", "shape"] }, { kind: "component", type: CxMenuComponent, selector: "cx-menu", inputs: ["disabled", "presentation", "ariaLabel", "heading", "items", "groups", "currentId", "shortcutsEnabled", "open", "align", "placement", "layout", "width"], outputs: ["openChange", "itemSelect", "currentIdChange"] }, { kind: "directive", type: CxMenuTriggerDirective, selector: "[cxMenuTrigger]" }, { kind: "component", type: CxTabsComponent, selector: "cx-tabs", inputs: ["ariaLabel", "controlsId", "items", "selectedId", "transparent", "divided", "equalWidth"], outputs: ["selectedIdChange"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
