...
type NormalizedCxImage = Required<Omit<CxImage, "intrinsicWidth" | "intrinsicHeight">> & Pick<CxImage, "intrinsicWidth" | "intrinsicHeight">;
export declare class CxImageComponent {
    ...
    protected readonly image$: import("@angular/core").Signal<NormalizedCxImage>;
