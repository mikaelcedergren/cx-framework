import { ChangeDetectionStrategy, Component, DestroyRef, ElementRef, EventEmitter, Input, Output, ViewChild, ViewContainerRef, afterNextRender, afterRenderEffect, computed, inject, signal, } from '@angular/core';
...
export class CxTextAreaComponent {
    ...
    layoutState = signal('default', /* @ts-ignore */
    ...
    constructor() {
        ...
        inject(DestroyRef).onDestroy(() => {
            ...
            if (this.headerView && !this.headerView.destroyed)
    ...
    syncHeaderVisibility() {
        if (!this.headerView || !this.headerElement || this.headerView.destroyed)
            return;
        ...
        if (hasContent && !attached)
            this.headerOutlet.insert(this.headerView);
        else if (!hasContent && attached)
            this.headerOutlet.detach(0);
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.8", ngImport: i0, type: CxTextAreaComponent, decorators: [{
            ...
            args: [{ selector: 'cx-text-area', imports: [CxIconComponent, CxValidationMessageComponent], host: {
                ...
                type: ViewChild,
                args: ['headerOutlet', { read: ViewContainerRef, static: true }]
            }], label: [{
                type: Input
            }], ariaLabel: [{
                type: Input
