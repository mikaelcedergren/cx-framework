...
export class CxDropdownComponent {
    ...
    ...(ngDevMode ? [{ debugName: "optionRowIndexes$" }] : /* istanbul ignore next */ []));
    virtualizedOptions$ = computed(() => this.rows$().length > CX_DROPDOWN_VIRTUALIZATION_THRESHOLD, /* @ts-ignore */
    ...
    virtualOptionsHeight$ = computed(() => this.virtualizedOptions$() ? this.rows$().length * this.optionHeightState() : 0, /* @ts-ignore */
    ...
    optionHeight$ = this.optionHeightState.asReadonly();
    labelText$ = computed(() => {
        const trimmedLabel = this.label.trim();
        return trimmedLabel || '';
    }, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "labelText$" }] : /* istanbul ignore next */ []));
    searchEnabled$ = this.searchableState.asReadonly();
