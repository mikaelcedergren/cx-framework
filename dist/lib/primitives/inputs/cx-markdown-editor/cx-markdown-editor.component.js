import { ChangeDetectionStrategy, ChangeDetectorRef, Component, EventEmitter, Input, Output, ViewChild, ViewEncapsulation, inject, signal, } from '@angular/core';
...
export class CxMarkdownEditorComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "22.0.8", type: CxMarkdownEditorComponent, isStandalone: true, selector: "cx-markdown-editor", inputs: { placeholder: "placeholder", layout: "layout", presentation: "presentation", ariaLabel: "ariaLabel", disabled: "disabled", value: "value" }, outputs: { valueChange: "valueChange", focusChange: "focusChange", blurred: "blurred" }, host: { properties: { "class.cx-markdown-editor-host--document": "presentation === \"document\"", "class.cx-markdown-editor-host--fill": "layout === \"fill\"", "class.cx-markdown-editor-host--disabled": "disabledState()" } }, viewQueries: [{ propertyName: "contentRef", first: true, predicate: ["content"], descendants: true, static: true }], ngImport: i0, template: "<div class=\"cx-markdown-editor\">\n  @if (showPlaceholder()) {\n    <div class=\"cx-markdown-editor__placeholder\" aria-hidden=\"true\">{{ placeholder!.trim() }}</div>\n  }\n  <div class=\"cx-markdown-editor__content\" #content></div>\n</div>\n", styles: ["cx-markdown-editor{display:block;width:100%;min-width:0}cx-markdown-editor.cx-markdown-editor-host--fill{height:100%;min-height:0}cx-markdown-editor>.cx-markdown-editor{position:relative;width:100%;height:100%;min-height:0}cx-markdown-editor .cx-markdown-editor__content{height:100%;min-height:0}cx-markdown-editor.cx-markdown-editor-host--fill .cx-markdown-editor__content{overflow-y:auto}cx-markdown-editor .cx-markdown-editor__placeholder{position:absolute;inset-block-start:0;inset-inline-start:0;color:var(--opacity-high);pointer-events:none}cx-markdown-editor .ProseMirror{position:relative;min-height:100%;box-sizing:border-box;outline:none;caret-color:var(--primary);color:var(--ink);word-wrap:break-word;white-space:pre-wrap;font-variant-ligatures:none}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror h1,cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror h2,cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror h3,cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror h4{margin:var(--space-sm) 0 var(--space-xs);font-weight:var(--font-weight-bold);line-height:var(--line-height-heading)}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror h1{font-size:var(--font-size-title-1)}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror h2{font-size:var(--font-size-title-2)}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror h3{font-size:var(--font-size-body)}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror>:first-child{margin-top:0}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror>:last-child{margin-bottom:0}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror p{margin:0 0 var(--space-sm)}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror ul,cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror ol{margin:0 0 var(--space-sm);padding-inline-start:1.5em;list-style-position:outside}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror li{margin-bottom:var(--space-2xs)}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror li>p{margin-bottom:var(--space-2xs)}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror li>p:last-child{margin-bottom:0}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror li::marker{color:var(--primary)}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror code{font-family:var(--font-family-mono);background:var(--opacity-low);padding:1px 4px;border-radius:var(--radius-xs)}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror pre{margin:0 0 var(--space-sm);padding:var(--space-sm);background:var(--opacity-low);border-radius:var(--radius-sm);overflow-x:auto}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror pre code{background:rgba(0,0,0,0);padding:0}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror blockquote{margin:0 0 var(--space-sm);padding-left:var(--space-sm);border-left:calc(var(--border-width)*2) solid var(--opacity-mid);color:var(--opacity-high)}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror a,cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror a:visited,cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror a:hover,cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror a:active{color:var(--link);text-decoration:underline}cx-markdown-editor:not(.cx-markdown-editor-host--document) .ProseMirror hr{margin:var(--space-sm) 0;border:0;border-top:var(--line)}cx-markdown-editor,cx-markdown-editor .cx-markdown-editor__placeholder{font-family:var(--font-family-base);font-size:var(--font-size-body);line-height:var(--line-height-body)}cx-markdown-editor.cx-markdown-editor-host--document,cx-markdown-editor.cx-markdown-editor-host--document .cx-markdown-editor__placeholder{font-size:var(--cx-article-base, 18px);line-height:1.6}cx-markdown-editor.cx-markdown-editor-host--disabled .ProseMirror{color:var(--opacity-high);cursor:default}cx-markdown-editor .ProseMirror pre{white-space:pre-wrap}cx-markdown-editor .ProseMirror li{position:relative}cx-markdown-editor .ProseMirror-hideselection *::selection{background:rgba(0,0,0,0)}cx-markdown-editor .ProseMirror-hideselection{caret-color:rgba(0,0,0,0)}cx-markdown-editor img.ProseMirror-separator{display:inline !important;border:none !important;margin:0 !important}"], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
