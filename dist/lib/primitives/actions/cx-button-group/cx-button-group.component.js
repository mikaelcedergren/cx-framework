...
export class CxButtonGroupComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "22.0.8", type: CxButtonGroupComponent, isStandalone: true, selector: "cx-button-group", inputs: { ariaLabel: "ariaLabel", availableValues: "availableValues", value: "value", size: "size", disabled: "disabled", fill: "fill" }, outputs: { valueChange: "valueChange" }, host: { properties: { "class.cx-button-group-disabled": "this.disabledHostClass", "class.cx-button-group-fill": "this.fillHostClass" } }, viewQueries: [{ propertyName: "rowRef", first: true, predicate: ["rowRef"], descendants: true }, { propertyName: "buttonRefs", predicate: ["buttonRef"], descendants: true, read: ElementRef }], ngImport: i0, template: "@if (buttons$().length > 0) {\n  <div\n    #rowRef\n    class=\"cx-button-group-row\"\n    [class.cx-button-group-row-has-indicator]=\"indicatorVisible$()\"\n    role=\"group\"\n    [attr.aria-label]=\"ariaLabel?.trim() || 'Options'\"\n  >\n    @if (indicatorVisible$()) {\n      <span\n        class=\"cx-button-group-indicator\"\n        aria-hidden=\"true\"\n        [style.width]=\"indicatorWidth\"\n        [style.height]=\"indicatorHeight\"\n        [style.transform]=\"'translate(' + indicatorX + ', ' + indicatorY + ')'\"\n      ></span>\n    }\n\n    @for (button of buttons$(); track button.id; let buttonIndex = $index) {\n      <button\n        #buttonRef\n        type=\"button\"\n        class=\"cx-button-group-button\"\n        [class.cx-button-group-button-selected]=\"button.selected\"\n        [class.cx-button-group-button-small]=\"size$() === 'small'\"\n        [class.cx-button-group-button-icon]=\"button.icon !== undefined\"\n        [class.cx-button-group-button-no-text]=\"!button.name\"\n        [class.cx-button-group-button-disabled]=\"button.disabled\"\n        [disabled]=\"disabled$() || button.disabled\"\n        [attr.aria-pressed]=\"button.selected\"\n        [attr.tabindex]=\"tabIndexFor(buttonIndex)\"\n        (click)=\"select($event, button)\"\n        (keydown)=\"onKeydown($event, buttonIndex)\"\n      >\n        @if (button.icon; as iconName) {\n          <cx-icon [icon]=\"iconName\" />\n        }\n        {{ button.name }}\n      </button>\n    }\n  </div>\n}\n", styles: [":host{position:relative;display:inline-block;width:max-content;border-radius:var(--radius-md);background:var(--opacity-low)}:host(.cx-button-group-disabled){cursor:default;opacity:var(--opacity-disabled);pointer-events:none}:host(.cx-button-group-fill){display:block;width:auto}:host(.cx-button-group-fill) .cx-button-group-row{display:flex}:host(.cx-button-group-fill) .cx-button-group-button{flex:1 1 0;justify-content:center}.cx-button-group-row{position:relative;display:inline-flex;flex-direction:row;flex-wrap:nowrap;gap:var(--space-xs);padding:var(--space-2xs);white-space:nowrap}.cx-button-group-indicator{position:absolute;z-index:0;top:0;left:0;border-radius:var(--radius-md);background:var(--emphasis);box-shadow:var(--shadow-low);pointer-events:none;transition:transform var(--motion-base) ease,width var(--motion-base) ease,height var(--motion-base) ease}.cx-button-group-button{position:relative;z-index:1;display:inline-flex;height:calc(var(--controller-size) - var(--space-xs));align-items:center;gap:var(--space-sm);margin:0;padding:0 var(--space-md);border:0;border-radius:var(--radius-md);background:rgba(0,0,0,0);color:var(--opacity-high);cursor:pointer;font:inherit;font-weight:var(--font-weight-regular);line-height:1;outline:none;transition:color var(--motion-fast) ease,background-color var(--motion-fast) ease;white-space:nowrap}.cx-button-group-button:hover{color:var(--ink)}.cx-button-group-button-icon{padding-left:var(--space-sm)}.cx-button-group-button-no-text{padding:0 var(--space-sm)}.cx-button-group-button-small{height:calc(var(--controller-size-small) - var(--space-xs));padding:0 var(--space-sm);border-radius:var(--radius-sm);font-size:var(--font-size-body-sm);line-height:var(--line-height-small)}:host:has(.cx-button-group-button-small){border-radius:var(--radius-sm)}.cx-button-group-row-has-indicator:has(.cx-button-group-button-small) .cx-button-group-indicator{border-radius:var(--radius-sm)}.cx-button-group-button-selected{color:var(--on-emphasis);background:var(--emphasis);box-shadow:var(--shadow-low)}.cx-button-group-row-has-indicator .cx-button-group-button-selected{background:rgba(0,0,0,0);box-shadow:none}.cx-button-group-button-selected:hover{color:var(--on-emphasis)}.cx-button-group-button:focus-visible{outline:var(--outline-tab);outline-offset:var(--outline-tab-offset)}.cx-button-group-button:active:not(:disabled){outline:var(--outline-active);outline-offset:var(--outline-active-offset)}:host(:not(.cx-button-group-disabled)) .cx-button-group-button:disabled{cursor:default;opacity:var(--opacity-disabled);pointer-events:none}@media(prefers-reduced-motion: reduce){.cx-button-group-indicator{transition:none}}"], dependencies: [{ kind: "component", type: CxIconComponent, selector: "cx-icon", inputs: ["icon", "size", "mood", "shape"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.8", ngImport: i0, type: CxButtonGroupComponent, decorators: [{
            type: Component,
            args: [{ selector: 'cx-button-group', imports: [CxIconComponent], changeDetection: ChangeDetectionStrategy.OnPush, template: "@if (buttons$().length > 0) {\n  <div\n    #rowRef\n    class=\"cx-button-group-row\"\n    [class.cx-button-group-row-has-indicator]=\"indicatorVisible$()\"\n    role=\"group\"\n    [attr.aria-label]=\"ariaLabel?.trim() || 'Options'\"\n  >\n    @if (indicatorVisible$()) {\n      <span\n        class=\"cx-button-group-indicator\"\n        aria-hidden=\"true\"\n        [style.width]=\"indicatorWidth\"\n        [style.height]=\"indicatorHeight\"\n        [style.transform]=\"'translate(' + indicatorX + ', ' + indicatorY + ')'\"\n      ></span>\n    }\n\n    @for (button of buttons$(); track button.id; let buttonIndex = $index) {\n      <button\n        #buttonRef\n        type=\"button\"\n        class=\"cx-button-group-button\"\n        [class.cx-button-group-button-selected]=\"button.selected\"\n        [class.cx-button-group-button-small]=\"size$() === 'small'\"\n        [class.cx-button-group-button-icon]=\"button.icon !== undefined\"\n        [class.cx-button-group-button-no-text]=\"!button.name\"\n        [class.cx-button-group-button-disabled]=\"button.disabled\"\n        [disabled]=\"disabled$() || button.disabled\"\n        [attr.aria-pressed]=\"button.selected\"\n        [attr.tabindex]=\"tabIndexFor(buttonIndex)\"\n        (click)=\"select($event, button)\"\n        (keydown)=\"onKeydown($event, buttonIndex)\"\n      >\n        @if (button.icon; as iconName) {\n          <cx-icon [icon]=\"iconName\" />\n        }\n        {{ button.name }}\n      </button>\n    }\n  </div>\n}\n", styles: [":host{position:relative;display:inline-block;width:max-content;border-radius:var(--radius-md);background:var(--opacity-low)}:host(.cx-button-group-disabled){cursor:default;opacity:var(--opacity-disabled);pointer-events:none}:host(.cx-button-group-fill){display:block;width:auto}:host(.cx-button-group-fill) .cx-button-group-row{display:flex}:host(.cx-button-group-fill) .cx-button-group-button{flex:1 1 0;justify-content:center}.cx-button-group-row{position:relative;display:inline-flex;flex-direction:row;flex-wrap:nowrap;gap:var(--space-xs);padding:var(--space-2xs);white-space:nowrap}.cx-button-group-indicator{position:absolute;z-index:0;top:0;left:0;border-radius:var(--radius-md);background:var(--emphasis);box-shadow:var(--shadow-low);pointer-events:none;transition:transform var(--motion-base) ease,width var(--motion-base) ease,height var(--motion-base) ease}.cx-button-group-button{position:relative;z-index:1;display:inline-flex;height:calc(var(--controller-size) - var(--space-xs));align-items:center;gap:var(--space-sm);margin:0;padding:0 var(--space-md);border:0;border-radius:var(--radius-md);background:rgba(0,0,0,0);color:var(--opacity-high);cursor:pointer;font:inherit;font-weight:var(--font-weight-regular);line-height:1;outline:none;transition:color var(--motion-fast) ease,background-color var(--motion-fast) ease;white-space:nowrap}.cx-button-group-button:hover{color:var(--ink)}.cx-button-group-button-icon{padding-left:var(--space-sm)}.cx-button-group-button-no-text{padding:0 var(--space-sm)}.cx-button-group-button-small{height:calc(var(--controller-size-small) - var(--space-xs));padding:0 var(--space-sm);border-radius:var(--radius-sm);font-size:var(--font-size-body-sm);line-height:var(--line-height-small)}:host:has(.cx-button-group-button-small){border-radius:var(--radius-sm)}.cx-button-group-row-has-indicator:has(.cx-button-group-button-small) .cx-button-group-indicator{border-radius:var(--radius-sm)}.cx-button-group-button-selected{color:var(--on-emphasis);background:var(--emphasis);box-shadow:var(--shadow-low)}.cx-button-group-row-has-indicator .cx-button-group-button-selected{background:rgba(0,0,0,0);box-shadow:none}.cx-button-group-button-selected:hover{color:var(--on-emphasis)}.cx-button-group-button:focus-visible{outline:var(--outline-tab);outline-offset:var(--outline-tab-offset)}.cx-button-group-button:active:not(:disabled){outline:var(--outline-active);outline-offset:var(--outline-active-offset)}:host(:not(.cx-button-group-disabled)) .cx-button-group-button:disabled{cursor:default;opacity:var(--opacity-disabled);pointer-events:none}@media(prefers-reduced-motion: reduce){.cx-button-group-indicator{transition:none}}"] }]
